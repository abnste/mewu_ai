...
<p align="center">
  <a href="./docs/images/teaching-review-zh.png"><img src="./docs/images/teaching-review-zh.png" width="100%" alt="试卷原位标注：左侧显示错误、正确和待核作答，右侧可核对识读、答案并调整判定" /></a>
</p>

*图为演示作答的实际界面。批改结果与生成的练习均需老师核对。*
