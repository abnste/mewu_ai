...
public partial class App : System.Windows.Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        TaskScheduler.UnobservedTaskException+=(_,args)=>{_logger.Error("Task",args.Exception);args.SetObserved();};
        AppDomain.CurrentDomain.UnhandledException+=(_,args)=>{if(args.ExceptionObject is Exception exception)_logger.Error("Process",exception);else _logger.Error("Process",new InvalidOperationException("进程发生非托管未处理错误"));};
