...
- README 正文按当前代码列全部已接入渠道和真实使用方式；区分 MiniMax M3、Codex/WorkBuddy 本机合成验证与其他账户/机器未验证范围，不得继续用“仅 API/Hermes”描述已经增加的渠道，也不扩大验证承诺。MiniMax Code 当前使用桌面会话兼容路径，不得写成官方公开 Agent SDK。
