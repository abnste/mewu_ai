<div align="center">
  ...
  **Capture, annotate, and understand content directly on your Windows screen.**
  ...
  [![Release](https://img.shields.io/badge/release-v0.0.3-6878F0?style=flat-square)](https://github.com/abnste/mewu_ai/releases/tag/v0.0.3)
  ...
  [**Download installer**](https://github.com/abnste/mewu_ai/releases/download/v0.0.3/MewuAI-Setup-0.0.3-win-x64.exe) · [Portable ZIP](https://github.com/abnste/mewu_ai/releases/download/v0.0.3/MewuAI-Portable-0.0.3-win-x64.zip)
</div>
...
- [Installer 0.0.3](https://github.com/abnste/mewu_ai/releases/download/v0.0.3/MewuAI-Setup-0.0.3-win-x64.exe): per-user setup with Start Menu entry, optional desktop shortcut, and uninstaller.
- [Portable 0.0.3](https://github.com/abnste/mewu_ai/releases/download/v0.0.3/MewuAI-Portable-0.0.3-win-x64.zip): extract and run `MewuAI.exe`; no separate .NET installation is required.
