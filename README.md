<div align="center">
  ...
  **Capture, annotate, and understand content directly on your Windows screen.**
  ...
  [![Release](https://img.shields.io/badge/release-v0.0.7-6878F0?style=flat-square)](https://github.com/abnste/mewu_ai/releases/tag/v0.0.7)
  ...
  [**Download installer**](https://github.com/abnste/mewu_ai/releases/download/v0.0.7/MewuAI-Setup-0.0.7-win-x64.exe) · [Portable ZIP](https://github.com/abnste/mewu_ai/releases/download/v0.0.7/MewuAI-Portable-0.0.7-win-x64.zip)
</div>
