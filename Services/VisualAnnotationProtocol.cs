...
style 允许 color:#RRGGBB、strokeWidth:0.001..0.1、opacity:0.05..1、filled:boolean、fontSize:0.01..0.2。text 使用 content:{text}，number 使用 content:{number}。callout 的 label 是气泡文字；其余 label 是用途说明。
