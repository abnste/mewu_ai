...
internal static class LocalizationService
{
    private static readonly Dictionary<string,string> English=new(StringComparer.Ordinal)
    {
        ...
        ["提问与历史"]="Prompt & history",["回到最新回复"]="Jump to latest",["查看提问和历史对话"]="View questions and conversation history",["查看提问与历史"]="View questions and history",["AI 回答"]="AI response",["同时复制为 Excel 表格、Markdown 和图片"]="Copy as an Excel table, Markdown, and an image",["复制识别出的表格"]="Copy recognized table",["复制表格"]="Copy table",["正在思考…"]="Thinking…",["Hermes 运行"]="Hermes activity",
