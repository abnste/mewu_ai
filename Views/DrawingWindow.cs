...
{
    private readonly BitmapSource _source; private readonly InkCanvas _ink=new(); private readonly Stack<Stroke> _redo=[];private ShapeTool _tool;private Point _shapeStart;private Stroke? _preview;
