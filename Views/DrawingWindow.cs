...
public sealed class DrawingWindow : Window
{
    ...
    private static void Btn(Panel p,string text,Action action){var b=new Button{Content=text,Margin=new Thickness(3),Padding=new Thickness(10,5,10,5),Background=new SolidColorBrush(Color.FromRgb(32,43,58)),Foreground=Brushes.White,BorderBrush=new SolidColorBrush(Color.FromRgb(49,67,91)),BorderThickness=new Thickness(1)};b.Click+=(_,_)=>action();p.Children.Add(b);}
